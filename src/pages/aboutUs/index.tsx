		...
		<div >
			...
			<div>
				...
				<div className=" container mt-3">
				 ...
				 <div className="team-member">
						<div className="img-wrap">
							<img src={ron} alt="ron" className='member-image' />
							<div style={{cursor:"pointer"}}><img  style={{position:"absolute"}} src={plus} className='plus-img'
							  /></div>
						</div>
						<div>
			...
			<div className="team-member">
						...
						<div>
							...
							<p className='member-title'>{t("yoni_title")}</p>
						</div>
						<p className='member-description container'>
							{t("yoni_description")}
						</p>
					...
					<div className="team-member">
						...
						<div>
							...
							<p className='member-title'>{t("tzahi_title")}</p>
						</div>
						<p className='member-description container'>
							{t("tzahi_description")}
						</p>
					...
					<div className="team-member">
						...
						<div>
							<h4 className='member-title'>{t("ore")}</h4>
							<p className='member-title'>{t("ore_title")}</p>
						</div>
						<p className='member-description container'>
							{t("ore_description")}
						</p>
