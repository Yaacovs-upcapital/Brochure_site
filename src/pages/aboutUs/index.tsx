...
import yoni from '../../assets/images/yoni.jpg'
import elad from '../../assets/images/elad.jpg'
import './aboutUs.css';
	...
	return (
		<div>
			...
			<div className="bg-img">
				<h1>{t("about")}</h1><h1 style={{ color: "red" }}>.</h1>
			</div>
			<div className="career-content container">
			<div className="text-container" >
					<div className="text-wrapper">
						<div className="career-second-title" style={{display:"flex"}}><h3 style={{color:"red"}}>.</h3><h3 style={{ lineHeight: "1" }}>Up Capital</h3></div>
			...
			<div>
				...
				<div className="team-container container">
					...
					<div className="team-member">
						<div className="img-wrap">
							<img src={elad} alt="yoni " className='member-image' />
						</div>
						<div>
							<h4 className='member-title '>אלעד הולנדר - סמנכ"ל שיווק ומכירות</h4>
						</div>
						<p className='member-description container'>
							אלעד מומחה לתורת המשחקים וכלכלה שיתופית, בעל ניסיון עשיר של כ 15 שנה בניהול צמיחה בחברות הזנק. במקביל אלעד יועץ מלווה לאקסלרטורים הגלובליים HYPE ו TECHSTARS. בהשכלתו אלעד בוגר תואר ראשון במדעי המחשב מאוניברסיטת תל אביב ותואר שני בפילוסופיה מידע ותרבות דיגיטלית, גם הוא מתל אביב.							</p>
					</div>
				</div>
			</div>
			<div className="partners container">
				<div style={{display:"flex", alignItems:"baseline", justifyContent:"center"}}><h2 className="partners-title">{t('partners')}</h2><h2 style={{color:'red'}}>.</h2></div>
				{useWindowSize() <= 767 ?
